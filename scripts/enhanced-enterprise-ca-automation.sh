...
CERTIFICATE_PASSWORD="${CERTIFICATE_PASSWORD:-<REMOVED_FROM_HISTORY>}"
...
param(
    ...
    [string]$Password = "<REMOVED_FROM_HISTORY>",
    [int]$ValidityYears = 3
)
...
try {
    ...
    Write-Host "CERTIFICATE_PASSWORD: <REMOVED_FROM_HISTORY>"
...
main() {
    ...
    case "$command" in
        ...
        "help"|"--help"|"-h")
            ...
            echo "  CERTIFICATE_PASSWORD    Certificate password (default: <REMOVED_FROM_HISTORY>)"
